import 'package:ecomm_store_app/features/shop/screens/product_reviews/widgets/progress_indicator.dart';
...
class MyOverAllProductRating extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [Expanded(flex: 3, child: Text('4.8' , style: Theme.of(context).textTheme.displayLarge,)),
